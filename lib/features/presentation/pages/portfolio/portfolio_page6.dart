...
import 'package:first_application/features/presentation/pages/portfolio/season6.dart';
import 'package:flutter/material.dart';
import 'package:tuple/tuple.dart';

class PortfolioPage6 extends StatefulWidget {
  PortfolioPage6({Key key}) : super(key: key);

  @override
  _PortfolioPage6State createState() => _PortfolioPage6State();
}

class _PortfolioPage6State extends State<PortfolioPage6>
    with SingleTickerProviderStateMixin {
  final List<Tuple3> _pages = [
    Tuple3('Season 6', Season6(), Icon(Icons.video_library)),
