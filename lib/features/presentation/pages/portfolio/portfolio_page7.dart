...
import 'package:first_application/features/presentation/pages/portfolio/season7.dart';
import 'package:flutter/material.dart';
import 'package:tuple/tuple.dart';

class PortfolioPage7 extends StatefulWidget {
  PortfolioPage7({Key key}) : super(key: key);

  @override
  _PortfolioPage7State createState() => _PortfolioPage7State();
}

class _PortfolioPage7State extends State<PortfolioPage7>
    with SingleTickerProviderStateMixin {
  final List<Tuple3> _pages = [
    Tuple3('Season 7', Season7(), Icon(Icons.video_library)),
