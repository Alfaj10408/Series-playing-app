...
import 'package:first_application/features/presentation/pages/portfolio/season8.dart';
import 'package:flutter/material.dart';
import 'package:tuple/tuple.dart';

class PortfolioPage8 extends StatefulWidget {
  PortfolioPage8({Key key}) : super(key: key);

  @override
  _PortfolioPage8State createState() => _PortfolioPage8State();
}

class _PortfolioPage8State extends State<PortfolioPage8>
    with SingleTickerProviderStateMixin {
  final List<Tuple3> _pages = [
    Tuple3('Season 8', Season8(), Icon(Icons.video_library)),
