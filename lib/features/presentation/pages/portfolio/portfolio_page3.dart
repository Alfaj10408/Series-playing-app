...
import 'package:first_application/features/presentation/pages/portfolio/season3.dart';
import 'package:flutter/material.dart';
import 'package:tuple/tuple.dart';

class PortfolioPage3 extends StatefulWidget {
  PortfolioPage3({Key key}) : super(key: key);

  @override
  _PortfolioPage3State createState() => _PortfolioPage3State();
}

class _PortfolioPage3State extends State<PortfolioPage3>
    with SingleTickerProviderStateMixin {
  final List<Tuple3> _pages = [
    Tuple3('Season 3', Season3(), Icon(Icons.video_library)),
