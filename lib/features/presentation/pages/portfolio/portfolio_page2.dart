...
import 'package:first_application/features/presentation/pages/portfolio/season2.dart';
import 'package:flutter/material.dart';
import 'package:tuple/tuple.dart';

class PortfolioPage2 extends StatefulWidget {
  PortfolioPage2({Key key}) : super(key: key);
...
class _PortfolioPage2State extends State<PortfolioPage2>
  ...
  final List<Tuple3> _pages = [
    Tuple3('Season 2', Season2(), Icon(Icons.video_library)),
