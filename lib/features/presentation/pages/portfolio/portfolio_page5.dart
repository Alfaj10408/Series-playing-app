...
import 'package:first_application/features/presentation/pages/portfolio/season5.dart';
import 'package:flutter/material.dart';
import 'package:tuple/tuple.dart';

class PortfolioPage5 extends StatefulWidget {
  PortfolioPage5({Key key}) : super(key: key);

  @override
  _PortfolioPage5State createState() => _PortfolioPage5State();
}

class _PortfolioPage5State extends State<PortfolioPage5>
    with SingleTickerProviderStateMixin {
  final List<Tuple3> _pages = [
    Tuple3('Season 5', Season5(), Icon(Icons.video_library)),
