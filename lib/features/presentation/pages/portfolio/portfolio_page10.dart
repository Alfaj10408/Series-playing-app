...
import 'package:first_application/features/presentation/pages/portfolio/season10.dart';
import 'package:flutter/material.dart';
import 'package:tuple/tuple.dart';

class PortfolioPage10 extends StatefulWidget {
  PortfolioPage10({Key key}) : super(key: key);

  @override
  _PortfolioPage10State createState() => _PortfolioPage10State();
}

class _PortfolioPage10State extends State<PortfolioPage10>
    with SingleTickerProviderStateMixin {
  final List<Tuple3> _pages = [
    Tuple3('Season 10', Season10(), Icon(Icons.video_library)),
